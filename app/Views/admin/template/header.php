            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        ...
                        <ul class="pro-body">
                            <li><a href="<?= base_url('/admin/dashboard'); ?>" class="dropdown-item"><i class="feather icon-user"></i> Profile</a></li>
                            <li><a href="<?= base_url('/admin/dashboard/'); ?>" class="dropdown-item"><i class="feather icon-settings"></i> Settings</a></li>
